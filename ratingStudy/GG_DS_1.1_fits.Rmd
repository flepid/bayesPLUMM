...
```{r}
data <- read.csv('C:\\Users\\Tomas\\Dropbox\\Aarhus\\PIPPET\\GG_online_study\\GG_DS_1\\fit_results.csv')
...
#get ratings
df_ratings <- read.csv('C:\\Users\\Tomas\\Dropbox\\Aarhus\\PIPPET\\GG_online_study\\GG_DS_1\\df_ratings.csv')
...
#tiff(file="C:\\Users\\Tomas\\Dropbox\\Aarhus\\PIPPET\\GG_online_study\\GG_DS_1\\K_hist.tiff", units = 'in', res = 300,width=5, height =4)
ggplot(data,aes(x = k))+
...
#tiff(file="C:\\Users\\Tomas\\Dropbox\\Aarhus\\PIPPET\\GG_online_study\\GG_DS_1\\spread_hist.tiff", units = 'in', res = 300,width=5, height =4)
...
```{r}
df_pred <- read.csv('C:\\Users\\Tomas\\Dropbox\\Aarhus\\PIPPET\\GG_online_study\\GG_DS_1\\predRatings_orig.csv')
...
#tiff(file="C:\\Users\\Tomas\\Dropbox\\Aarhus\\PIPPET\\GG_online_study\\GG_DS_1\\pred_TM.tiff", units = 'in', res = 300,width=5, height =4)
ggplot(df_pred, aes(x = Complexity, y = simMoveScore)) +
